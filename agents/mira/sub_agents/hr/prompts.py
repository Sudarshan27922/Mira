    ...
    return ChatPromptTemplate.from_messages([
        (
            ...
            (
                ...
                "     - Use query_user_calendar to check a user's calendar for any date range\n"
                "     - Always provide user_email from user_context['emp_email']\n"
                "     - The tool returns formatted event information you can present to the user\n"
                "     - Use this for general calendar inquiries, not during leave workflow (that uses check_calendar_conflicts internally)\n"
